/*Liang, Y.D. (2019). Introduction to Java Programming and Data Structures: 
    ...
    Cyberactive., Instruction to Assignment 9.2.,10.2
...
public class SaravananGradeBookApp extends Application
{
    ...
    //@Override
        ...
        private void viewGrades()
        {
            ...
            System.out.println("Grade Entries");
    ...
    private void savegrade(TextField firstNameField, TextField lastNameField, TextField courseField,ComboBox<String> gradeComboBox)
    {
        ...
        //Display the saved entry in the UI(Using the student's class toString)
        System.out.println("Saved Grade entry: "+ student.getFirstName() + " "+ student.getLastName() +" "+ "-Course: "+student.getCourse() +" " +"Grade: "+ student.getGrade());
    }

/*Liang, Y.D. (2019). Introduction to Java Programming and Data Structures: 
    ...
    Cyberactive., Instruction to Assignment 7.2.,
...
public class SaravananFutureValueApp extends Application
{
    ...
    public void start(Stage primaryStage)
    {
        ...
        comboBox.setPrefWidth(150);//set the required width for the combo
